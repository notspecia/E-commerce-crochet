...
import Vue3Toastify, { type ToastContainerOptions } from 'vue3-toastify'; // toastification configuration
...
// import css dela libreria vue toastify
...
app.use(Vue3Toastify, { // utilizzo nell'app libreria vue toastify
    theme: 'light',
    autoClose: 5000,
    multiple: true,
